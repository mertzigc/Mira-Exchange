...
### Avtal-fliken: full CRUD inflyttad i kortet — KLAR + verifierat 2026-08-17 (ej deployat)
Kortets Avtal-flik var READ-vy; native-fliken hade två separata block. Nu är **båda blocken inflyttade** i `mira-foretag-lista.html` — native Avtal-fliken, `mira-abonnemang-kund.html` och `mira-approval-create.html` kan pensioneras för kundkortet. **Ingen ny backend, ingen Bubble-schemaändring** — alla endpoints fanns redan.
