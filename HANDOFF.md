...
| **Fastighetsägarvyn** | ✅ LIVE. Tre buggar rättade 2026-09-04: namnrymden `.fa` krockade med Font Awesome, blocket gav upp på 401 i stället för att vänta in tokenförnyelse, och `x-landlord-secret` var osynkad mellan Render och API Connectorn. Se FASTIGHETSAGARVYN.md §5.4b–d. **Nästa: aktivitetsspåren** (§8 steg 6), men Tengella-orgnr bör gå före | Christian |
