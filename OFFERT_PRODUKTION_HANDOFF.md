...
> Detaljerad, färsk logg finns i minnet `project-offert-produktion-fe.md` (läs den + denna). Denna sektion = snabb överblick. Fokus senaste sessionen: **samlade Affär-vyn** (inline edit, wizard-fixar, Tengella-order, manuell koppling).
